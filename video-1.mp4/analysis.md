...
![camera-coords-query-wcs-xy.svg](./spatial-analysis/camera-coords-query-wcs-xy.svg)
...
Table Forensic Motion Event Summary
...
```bash
$ python ../tools/5.a.court-ready-audit.py --media-name 1.mp4 --v0 0.967 --conclusion-csv ./audio-analysis/4e.forensic-conclusion-report.csv --map-csv ./audio-analysis/4d.final-map-coords-4c.reconciled-4b.discern-nature-key-seq-audio-preferred-channel.wav.csv 
Success: Forensic Audit generated for 1.mp4 -> audit-1.mp4.md
```
